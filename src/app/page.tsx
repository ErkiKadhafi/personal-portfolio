          ...
          >
            ...
            <article className="flex flex-col justify-center gap-y-3 sm:gap-y-3.5 lg:gap-y-4">
              ...
              <p className="text-sm sm:text-base lg:text-lg">
                ...
                experiences using React and Next.js. My commitment to clean code
                ensures optimal functionality and maintainability.
              </p>
            </article>
          </div>
        ...
        <div className="layout py-10 lg:py-16">
          ...
          <ul className={clsx("grid sm:grid-cols-2", "gap-6 sm:gap-6")}>
            {myTechstack.map((item, index) => (
              <li
                key={index}
                className={clsx(`flex list-custom before:content-['01']`)}
              >
                <article className="space-y-3 sm:space-y-3.5">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg">{item.desc}</p>
                </article>
              </li>
            ))}
          </ul>
