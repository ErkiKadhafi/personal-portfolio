...
<ImageGallery>
  ...
  <div className="flex-col space-y-4">
    <LightBox
      imageSrc="modalin/home-page.png"
      imageAlt="Home page."
      customSize={true}
      width={1920}
      height={5582}
    />
    <LightBox
      imageSrc="modalin/about-page.png"
      imageAlt="About page."
      customSize={true}
      width={1920}
      height={2431}
  ...
  <div className="flex-col space-y-4">
    <LightBox
      imageSrc="modalin/product-page.png"
      imageAlt="Detail product page."
      customSize={true}
      width={1920}
      height={5982}
    />
    <LightBox
      imageSrc="modalin/video-popup.png"
      imageAlt="Video detail product popup."
      customSize={true}
      width={1920}
      height={894}
    />
    <LightBox
      imageSrc="modalin/form-registration.png"
      imageAlt="Form registration product."
      customSize={true}
      width={1920}
      height={894}
    />
