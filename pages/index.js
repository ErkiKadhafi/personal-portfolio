          ...
          <div className="flex items-center ">
            ...
            >
              ...
              <p className="font-semibold text-banner md:text-banner-md dark:banner-glow">
                Frontend <span className="dark:flicker-animation">Web</span>{" "}
                Developer.
              </p>
              <p className="text-lg md:text-banner-desc-md max-w-[32em] ">
                I work with React and Laravel ecosystem, I love building
                projects that useful for others.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <ul className="flex flex-wrap text-white text-3xl ">
                  {item.techStacks.map((icon, index) => (
                    ...
                    >
                      <Icon iconName={icon} tooltip={icon} />
                    </li>
                  ))}
                </ul>
        ...
        <div className="layout py-16 text-black-primary">
          ...
          <ul className="space-y-4">
            {projects.map((project, index) => (
              <li
                data-aos="fade-up"
                data-aos-delay={`${(index + 1) * 2 * 100 + 300}`}
                key={index}
                ...
                <Link href={`/projects/${project.slug}`}>
                  <a className="dark:text-white">
                    ...
                    <ul className="flex flex-wrap">
                      {project.techStacks.split(",").map((techStack, index) => {
                        return (
                          <li
                            key={index}
